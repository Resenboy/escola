class NotaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @notum.save
        format.html { redirect_to @notum, notice: 'Nota lançada com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @notum.update(notum_params)
        format.html { redirect_to @notum, notice: 'Nota corrigida com sucesso!' }
  ...
  def destroy
    @notum.destroy
    respond_to do |format|
      format.html { redirect_to nota_url, notice: 'Nota apagada com sucesso.' }
  ...
  private
    ...
    def notum_params
      params.require(:notum).permit(:curso_id, :aluno_id, :professor_id, :data, :nota1, :nota2, :nota3)
    end
end
