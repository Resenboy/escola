...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { cpf: @aluno.cpf, email: @aluno.email, image: @aluno.image, nome: @aluno.nome, ra: @aluno.ra, rg: @aluno.rg }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { cpf: @aluno.cpf, email: @aluno.email, image: @aluno.image, nome: @aluno.nome, ra: @aluno.ra, rg: @aluno.rg }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
