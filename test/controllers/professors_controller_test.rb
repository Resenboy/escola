...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { disciplina: @professor.disciplina, nome: @professor.nome, registro: @professor.registro }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { disciplina: @professor.disciplina, nome: @professor.nome, registro: @professor.registro }
    assert_redirected_to professor_path(assigns(:professor))
  end
